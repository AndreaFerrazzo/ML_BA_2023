...
recipes_raw_calories <- recipes_raw_calories %>% 
  filter(n_value <= 7000)
...
recipes_raw_protein <- recipes_raw_boxplot %>% 
...
recipes_raw_protein <- recipes_raw_protein %>% 
  filter(n_value <= 1000)
...
recipes_raw_sodium <- recipes_raw_boxplot %>% 
...
recipes_raw_sodium <- recipes_raw_sodium %>% 
...
recipes_raw_fat <- recipes_raw_boxplot %>% 
...
recipes_raw_fat <- recipes_raw_fat %>% 
