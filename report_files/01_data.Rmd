...
interesting <- c("dairy_free", "entertaining", "epi_loves_the_microwave", "friendsgiving", "game", "gourmet", "healthy", "high_fiber", "hors_doeuvre", "hot_drink", "kid_friendly", "kidney_friendly", "low_cal", "low_cholesterol", "microwave", "no_cook", "one_pot_meal", "oscars", "paleo", "peanut_free", "pescatarian", "poker_game_night", "potluck", "quick_easy", "sugar_conscious", "vegetable", "wheat_gluten_free", "winter", "cookbooks", "leftovers")
...
cooking_techniques <- c("raw", "saute", "freeze_chill", "fry", "stir_fry", "simmer", "boil", "broil", "bake", "braise", "chill", "deep_fry")
...
spices <- c("caraway", "cardamom", "chili", "cinnamon", "clove", "cumin", "curry", "hot_pepper", "jalapeno", "marinade", "nutmeg", "paprika", "pepper", "poppy", "saffron", "sesame", "sesame_oil", "soy_sauce", "spice", "vanilla", "wasabi")

#top level categories
meats <- c(beef_meat, pork_meat, lamb_meat, meat_with_wings)
# fish <- list(stuff_in_the_water)
# vegetables_list <- list(vegetables)
all_ingredients <- c(vegetables, pork_meat, lamb_meat, beef_meat, meat_with_wings, meat_various, stuff_in_the_water, herbs, nuts, cereal, carbs, fruits, drink_no_alcohol, dessert, cheese, dairy, spices)
...
to_remove_temp <- c(us_states, us_cities, countries, alcohol, wtf, chef, interesting, season, celebrations, tools, cooking_techniques, nutritional_values, repice_type, diet_preferences, vegetables, pork_meat, lamb_meat, beef_meat, meat_with_wings, meat_various, stuff_in_the_water, herbs, nuts, cereal, carbs, fruits, drink_no_alcohol, to_sort, dessert, cheese, dairy, spices)
