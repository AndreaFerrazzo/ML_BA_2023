...
Creating a new df for analysis purposes, which includes all nutrition-related features, as well as all ingredient-related features. We name it `recipes_analysis`.
...
## Logistic Regression with balanced data - TO REMOVE BECAUSE DUPLICATE?
