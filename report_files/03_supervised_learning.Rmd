...
#show the random forest with cv 
rf_down_fit
plot(rf_down_fit, main = "Plot of CV Accuracy relative to Mtry parameter")
```
...
```{r}
#make predictions
rf_down_pred <- predict(rf_down_fit, newdata = test_bin_Nut)

#confusion matrix 
confusionMatrix(data = rf_down_pred, reference = test_bin_Nut$rating)
```
