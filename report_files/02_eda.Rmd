...
boxplot_calories <- recipes_plot %>%
  ...
  ggtitle("Boxplot of calories nutritional value filtered") +
  xlab("") +
  ylab("Calories") 
...
```
We now have only 2 categories: recipes with rating above 4 and recipes with ratings below 4. There is no clear relationship in those graphs either, and this confirms the correlation results that we have found above.
