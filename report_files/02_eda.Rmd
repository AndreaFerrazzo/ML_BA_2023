...
#### Creating binary ingredients columns
...
#### Adding total ingredients columns
...
#### Relationship between binary ingredients categories and 7-level rating variable
...
#### Relationship between binary ingredients categories and binary rating variable
...
#### Correlation between total number of ingredients per category and 7-level rating variable
...
#### Correlation between total number of ingredients per category and binary rating variable
