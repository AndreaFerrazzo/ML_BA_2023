...
## KNN - rating_bin with NUT, BIN and TOTAL - NOT NORMALISED
...
### Tuning K
Best K if we look at both accuracy and Kappa is 1.
```{r}
...
knn_cv <- caret::train(rating_bin ~.,
                ...
                trControl = trCtrl,
                metric = "Accuracy",
                tuneGrid= data.frame(k = seq(111, 131,by = 2))#best is 121
                )
knn_cv
```
